...
# only single label 
    ...
    with st.sidebar:
        score_threshold=st.slider("Confidence Threshold", 0.00,1.00,st.session_state.conf,0.01)
        nms_threshold =st.slider("NMS Threshold", 0.00, 1.00,st.session_state.conf, 0.01)
